 ...
 * @version $Date: 2019/01/09 15:43:01 $
 */
abstract class Type implements Printable, Comparable {
	...
	/**
	 * Tells if this type can be cast to the target type by the cast(LHS,THIS)
	 * PHPLint magic function.
	 * @param Type $lhs Target type to cast into.
	 * @return boolean True if the requested cast is supported.
	 */
