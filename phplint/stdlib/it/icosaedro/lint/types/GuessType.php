 ...
 * of its existence and handle it properly in the attempt to guess automatically
 * the right returned type.
 * @author Umberto Salsi <salsi@icosaedro.it>
 * @version $Date: 2019/01/21 20:17:56 $
 */
final class GuessType extends Type {
	...
	/**
	 * Always return false. This guarantees that if the function or method
