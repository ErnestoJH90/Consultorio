 ...
 * @version $Date: 2019/01/09 15:45:56 $
 */
class DateTime implements Printable, Hashable, Sortable, Serializable
{
	...
	/**
	 * Returns this date time formatted as per the given format specifier.
	 * The only recognized characters of the format specifier are the digits
