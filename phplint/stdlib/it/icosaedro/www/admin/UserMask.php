...
/**
 * Administrative mask to set user's data and permissions.
 * @author Umberto Salsi <salsi@icosaedro.it>
 * @version $Date: 2018/12/25 01:49:22 $
 */
...
//		$this->last_login = new Spinner($this, "last_login");
	...
	{
		// Ask confirmation and invoke deleteUserConfirm().
		$this->returnTo("deleteUserConfirm");
	 ...
	 * @throws SQLException
	 */
	function deleteUserConfirm($confirmed)
	{
		if( ! $confirmed ){
			$this->render();
			return;
